...
public class SpeedLinkiumStickItem extends LinkiumModElements.ModElement {
	@ObjectHolder("linkium:speed_linkium_stick")
	public static final Item block = null;
	public SpeedLinkiumStickItem(LinkiumModElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("speed_linkium_stick");
		}
