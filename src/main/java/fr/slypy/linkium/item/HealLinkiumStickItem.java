...
public class HealLinkiumStickItem extends LinkiumModElements.ModElement {
	@ObjectHolder("linkium:heal_linkium_stick")
	public static final Item block = null;
	public HealLinkiumStickItem(LinkiumModElements instance) {
		super(instance, 88);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("heal_linkium_stick");
		}
