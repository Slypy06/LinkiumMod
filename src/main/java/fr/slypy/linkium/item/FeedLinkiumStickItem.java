...
public class FeedLinkiumStickItem extends LinkiumModElements.ModElement {
	@ObjectHolder("linkium:feed_linkium_stick")
	public static final Item block = null;
	public FeedLinkiumStickItem(LinkiumModElements instance) {
		super(instance, 84);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("feed_linkium_stick");
		}
