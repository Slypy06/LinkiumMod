...
public class StrengthLinkiumStickItem extends LinkiumModElements.ModElement {
	@ObjectHolder("linkium:strength_linkium_stick")
	public static final Item block = null;
	public StrengthLinkiumStickItem(LinkiumModElements instance) {
		super(instance, 80);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("strength_linkium_stick");
		}
