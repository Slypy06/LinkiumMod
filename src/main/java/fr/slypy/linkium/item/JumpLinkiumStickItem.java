...
public class JumpLinkiumStickItem extends LinkiumModElements.ModElement {
	@ObjectHolder("linkium:jump_linkium_stick")
	public static final Item block = null;
	public JumpLinkiumStickItem(LinkiumModElements instance) {
		super(instance, 83);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("jump_linkium_stick");
		}
