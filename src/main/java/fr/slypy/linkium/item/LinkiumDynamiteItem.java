...
import fr.slypy.linkium.entity.renderer.LinkiumDynamiteRenderer;
import fr.slypy.linkium.LinkiumModElements;

@LinkiumModElements.ModElement.Tag
public class LinkiumDynamiteItem extends LinkiumModElements.ModElement {
	@ObjectHolder("linkium:linkium_dynamite")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.75f, 0.75f)).build("linkium_dynamite").setRegistryName("linkium_dynamite");
	public LinkiumDynamiteItem(LinkiumModElements instance) {
		super(instance, 65);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LinkiumDynamiteRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("linkium_dynamite");
		}
	...
	public static class ArrowCustomEntity extends ThrowableEntity implements IRendersAsItem {
		...
		protected void explode() {
			...
			this.world.createExplosion(this, this.getPosX(), this.getPosYHeight(0.0625D), this.getPosZ(), 6.5F, Explosion.Mode.BREAK);
		...
		public ItemStack getItem() {
			...
			return new ItemStack(LinkiumDynamiteItem.block);
